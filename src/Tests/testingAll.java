...
class testingAll
{
    ...
    public void Test16(){
        ...
        assertEquals(intersectionPointsSphere1.size(), 2);
        assertEquals(intersectionPointsSphere2.size(), 9);
    ...
    public void Test18()
    {
        ...
        assertEquals(intersectionPointsPlane1.size(), 9);
...
//         scene.set_ambientLight(new AmbientLight(Color.BLACK);
        ...
        triangle2.setEmmission( new Color(1, 6, 6));
        triangle3.setEmmission( new Color(6, 6, 0));
        triangle4.setEmmission( new Color(230, 231, 255));
